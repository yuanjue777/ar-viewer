...
- 开局是布阵阶段，点右上角 ▶ 才开波。共 **25 波**，每 **35 秒**一波自动来；逢5(5/15/25)是精英波、逢10(10/20)是纯Boss关，最后一波总攻。
  ...
  - **前5波是新手期（刻意做简单）**：数量改用 `2+floor(1.5w)`（3/5/6/8/10只）；强度另乘折扣 `[.7,.75,.82,.88,.94]`（第6波起无缝接回原曲线）；**快速怪w4才出、坦克w5才出**（w5每6只掺1、w6每5只、w7起每4只）；第5波精英只来1只且倍率只有1.25。
  - 实测总血量：w1=84 w2=176 w3=266 w4=399 w5=1044 w6=1822 w7=2441 w8=3205；**裸跑测试**（2英雄不买任何技能装备）前5波掉0命、血量几乎不掉。
